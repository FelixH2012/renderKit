		...
		<section className={`renderkit-block renderkit-product-grid ${className || ''}`.trim()}>
			<div className="rk-product-grid__inner">
				...
				<header className="rk-product-grid__header">
					<h2 className="rk-product-grid__title">Unsere Produkte</h2>
				</header>
				...
				<div className="rk-scatter-grid">
					{products.map((product, index) => {
						...
						return (
							...
							>
								<a href={product.url} className="rk-scatter-card__link">
									...
									<div className="rk-scatter-card__content">
										<h3 className="rk-scatter-card__title">{product.title}</h3>
										...
										{/* CTA */}
										<span className="rk-scatter-card__cta">
											<span className="rk-scatter-card__cta-text">Ansehen</span>
											<svg className="rk-scatter-card__cta-arrow" width="16" height="16" viewBox="0 0 16 16" fill="none">
